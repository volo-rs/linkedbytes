# Contributing to LinkedBytes

:balloon: Thanks for your help improving the project! We are so happy to have you!

There are opportunities to contribute to LinkedBytes at any level. It doesn't matter if
...
<img src="https://github.com/volo-rs/linkedbytes/raw/main/.github/assets/volo-feishu-dev-group.png" alt="Volo dev group" width="50%" height="50%" />

_This guide is adapted from the [Tokio contributing guide](https://github.com/tokio-rs/tokio/blob/master/CONTRIBUTING.md)_.

## Conduct

See the [LinkedBytes Code of Conduct](https://github.com/volo-rs/linkedbytes/blob/main/CODE_OF_CONDUCT.md).
...
1. By opening the issue for discussion: For instance, if you believe that you
   have discovered a bug in linkedbytes, creating a new issue in [the volo-rs/linkedbytes
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   LinkedBytes in a concrete and reviewable manner.

[issue]: https://github.com/volo-rs/linkedbytes/issues
...
When opening a new issue in the LinkedBytes issue tracker, you will be presented
...
cases should be limited, as much as possible, to using only LinkedBytes APIs.
...
functional guidelines of the LinkedBytes project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the LinkedBytes repository.
...
example), it is either adding new functionality to LinkedBytes or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that LinkedBytes does not regress in the future.
...
**Any LinkedBytes community member is welcome to review any pull request**.

All LinkedBytes contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for LinkedBytes?
2. Does this change make LinkedBytes better, even if only incrementally?
...
avoid stalling the Pull Request. Most nits can typically be fixed by the LinkedBytes
...
a particular change that makes LinkedBytes better, but the individual might just not
want to have anything to do with LinkedBytes ever again. The goal is not just having
good code.
...
The LinkedBytes GitHub repository has a lot of issues and PRs to keep track of. This
...
The area label describes the crates relevant to this issue or PR.
 ...
 - **A-linkedbytes** This issue concerns the `linkedbytes` crate.
